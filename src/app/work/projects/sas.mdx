...
<Badge id="badge-1" title="My Role & Responsibilities" icon="group2" effect={false} arrow={false} paddingX="12" onBackground="brand-medium" background="brand-alpha-weak" textVariant="label-default-s" />
...
<Badge id="badge-2" title="Outcome & Learnings" icon="bulb" effect={false} arrow={false} paddingX="12" onBackground="brand-medium" background="brand-alpha-weak" textVariant="label-default-s" marginTop="32" />
