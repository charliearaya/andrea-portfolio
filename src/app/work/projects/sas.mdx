...
description: "Scandinavia’s leading international airline"
subheading: "2025 • UI Design, Design System, Website Redesign"
images:
  - "/images/projects/sas/cover_01.webp"
  - "/images/projects/sas/image_04.webp"
  - "/images/projects/sas/cover_02.webp"
  - "/images/projects/sas/cover_03.webp"
...
<Carousel
  ...
  items={[
      { slide: "/images/projects/sas/image_01.webp", alt: "Image 1" },
      { slide: "/images/projects/sas/image_02.webp", alt: "Image 2" },
      { slide: "/images/projects/sas/image_03.webp", alt: "Image 3" },
  ]}
/>
<br />
<br />
...
<Grid fillWidth columns="2" gap="s" s={{ columns: 1 }} marginTop="16">
  <List as="ul" role="list">
    <ListItem role="listitem" onBackground="neutral-weak" marginBottom="s" style={{ lineHeight: "1.5rem" }}>
      Designed to scale from 1 to 6 banners, adapting to grid or carousel layouts depending on screen size.
    </ListItem>
    <ListItem role="listitem" onBackground="neutral-weak" marginBottom="s">
...
<Carousel
  ...
  sizes="(max-width: 960px) 100vw, 960px"
  items={[
      { slide: "/images/projects/sas/image_04.webp", alt: "Image 4" },
      { slide: "/images/projects/sas/image_05.webp", alt: "Image 5" },
  ]}
/>
<br />
<br />
...
<Carousel
  ...
  sizes="(max-width: 960px) 100vw, 960px"
  items={[
      { slide: "/images/projects/sas/image_06.webp", alt: "Image 6" },
      { slide: "/images/projects/sas/image_07.webp", alt: "Image 7" },
      { slide: "/images/projects/sas/image_08.webp", alt: "Image 8" },
      { slide: "/images/projects/sas/image_13.webp", alt: "Image 13" },
  ]}
/>
<br />
<br />
...
<Carousel
  ...
  sizes="(max-width: 960px) 100vw, 960px"
  items={[
      { slide: "/images/projects/sas/cover_04.webp", alt: "Image 9" },
      { slide: "/images/projects/sas/image_10.webp", alt: "Image 10" },
      { slide: "/images/projects/sas/image_14.webp", alt: "Image 14" },
      { slide: "/images/projects/sas/image_11.webp", alt: "Image 11" },
  ]}
/>
<br />
<br />
